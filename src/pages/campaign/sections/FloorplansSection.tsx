      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="rounded-xl border border-[#E8DCCB] bg-gray-50 p-4">
          <div className="flex items-center justify-between gap-3">
            <div className="text-sm font-semibold text-[#2E2E2E]">BHK tabs</div>
            <button
              type="button"
          ...
          <div className="text-sm font-semibold text-[#2E2E2E]">Blueprint image URL</div>
          <div className="mt-3">
          ...
          <div className="mt-4 flex gap-2">
            {floorTabs.map((tab) => (
              <button
                key={tab.id}
                type="button"
                className={floorDefaultTab === tab.id ? 'h-9 px-3 rounded-lg bg-violet-600 text-white text-xs font-semibold' : 'h-9 px-3 rounded-lg border border-[#E8DCCB] bg-white text-[#2E2E2E] text-xs font-semibold hover:bg-[#F5EFE7]'}
          ...
          <div className="mt-4 rounded-xl border border-[#E8DCCB] bg-white p-3">
            <div className="font-semibold text-[#2E2E2E]">Rows (Configuration / Carpet / Floor / Price)</div>
            <div className="mt-3 grid grid-cols-1 gap-3">
              ...
              <button
                type="button"
                className="h-9 px-3 rounded-lg border border-[#E8DCCB] bg-white text-[#2E2E2E] text-xs font-semibold hover:bg-[#F5EFE7] w-max"
                onClick={() =>
                  setFloorRows((p) => ({
                    ...p,
        ...
        <div className="rounded-xl border border-[#E8DCCB] bg-gray-50 p-4">
          <div className="flex items-center justify-between gap-3">
            <div className="text-sm font-semibold text-[#2E2E2E]">Floor plan images ({floorDefaultTab})</div>
            <button
              type="button"
              className="h-9 px-3 rounded-lg border border-[#E8DCCB] bg-white text-[#2E2E2E] text-xs font-semibold hover:bg-[#F5EFE7]"
              onClick={() =>
          ...
          <div className="mt-1 text-xs text-[#8B7355]">Upload or paste image URL. You can remove images.</div>
