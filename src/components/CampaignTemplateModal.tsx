  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-[520px] rounded-xl border border-[#8B7355]/10 bg-white p-5 shadow-[0_20px_60px_rgba(17,24,39,0.18)]">
        ...
        <div className="mt-1 text-[13px] font-medium text-[#8B7355]">Select which microsite template to use for this campaign.</div>
        ...
        <div className="mt-5 grid gap-3">
          <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-[#E8DCCB] p-3 hover:bg-[#F5EFE7]">
            ...
            <div>
              ...
              <div className="text-[12px] font-medium text-[#8B7355]">Best for premium projects.</div>
            </div>
          </label>
          ...
          <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-[#E8DCCB] p-3 hover:bg-[#F5EFE7]">
            ...
            <div>
              ...
              <div className="text-[12px] font-medium text-[#8B7355]">Best for budget/affordable projects.</div>
            </div>
          </label>
        </div>
